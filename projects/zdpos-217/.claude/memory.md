# zdpos_dev Project Memory

Stable project knowledge has been promoted to rules and skills. See:

- Framework/layer conventions, PHP 5.6 syntax, helper priority → `.claude/rules/php/coding-style.md` + `php/yii-framework.md` + `php/patterns.md`
