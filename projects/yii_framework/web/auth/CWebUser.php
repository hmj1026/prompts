...
class CWebUser extends CApplicationComponent implements IWebUser
{
	...
	public function login($identity,$duration=0)
    {
		...
		$zdn = isset($identity->zdn)?$identity->zdn:"";
	...
	public function getLevel(){
		return $this->getState("__level",10);
	}
	...
	public function setLevel($value){
		...
		if(0<=$level && $level<=10){
			$this->level = $level;
			$this->setState("__level",$level,10);
		}
	}
	
	public function getPermission(){
		if(($premission=$this->getState('__premission',''))!=""){
			return explode(",",$premission);
		}else{
			return array();
		}
	}
	...
	public function setStore($store){
		$this->setState("__store",$store,0);
	}
	
	public function getStore(){
		return $this->getState("__store",0);
	}

	public function setStation($station){
		$this->setState("__station",$station,0);
	}
	
	public function getStation(){
		return $this->getState("__station",0);
	}	
	
	public function setPermission($value){
		$this->setState('__premission',$value);
	}

	public function hasPermission($site){
		return in_array($site,$this->getPermission());
	}
	
	public function setLimit($value){
		$this->setState('__limit',$value);
	}
	
	public function getLimit(){
		return $this->getState('__limit',10);
	}
	
	public function setZdn($zdn){
		$this->setState("__zdn",$zdn,0);
	}
	
	public function getZdn(){
		return $this->getState("__zdn",0);
	}
	//自定結束===============================================================================================================
	/**
