---
name: php-pro
description: Use when building or maintaining PHP applications with modern PHP 8.3+ features, Laravel, Symfony, or legacy PHP 5.6 and Yii 1.1. Invoke for strict typing, PHPStan level 9, async patterns with Swoole, PSR standards, or legacy compatibility guidance.
---
...
| Legacy PHP 5.6 | `references/php56-legacy.md` | Variadics, unpacking, const exprs, migration guidance |
...
| Yii 1.1 | `references/yii1-1.md` | Entry script, config, controllers, AR, routing |
