        ...
        1: [function (b, c, d) {
            (function (b) {
                !function (e) {
                    ...
                    function i(a) {
                        for (var b, c, d = [], e = 0,
                                 f = a.length; e < f;)b = a.charCodeAt(e++), b >= 55296 && b <= 56319 && e < f ? (c = a.charCodeAt(e++), 56320 == (64512 & c) ? d.push(((1023 & b) << 10) + (1023 & c) + 65536) : (d.push(b), e--)) : d.push(b);
                        return d
                    }
                    ...
                    function o(a) {
                        ...
                        for (d = e = u.length, e && u.push(E); d < q;) {
                            ...
                            for (r = d + 1, j - b > K((w - c) / r) && f("overflow"), c += (j - b) * r, b = j, h = 0; h < q; ++h)if (p = a[h], p < b && ++c > w && f("overflow"), p == b) {
            ...
            function f(a, b) {
                for (var c = 3 === a.nodeType ? document.createTextNode(a.nodeValue) : a.cloneNode(!1),
                         d = a.firstChild; d;)b !== !0 && 1 === d.nodeType && "SCRIPT" === d.nodeName || c.appendChild(f(d, b)), d = d.nextSibling;
            ...
            function g(a, b, c, d, e) {
                var f = b.contentWindow, g = new k(f.document), j = new m(c, g), l = t(a),
                    o = "view" === c.type ? d : l.right + 1, q = "view" === c.type ? e : l.bottom + 1,
                    r = new c.renderer(o, q, j, c, document), s = new n(a, r, g, j, c);
                return s.ready.then(function () {
                    ...
                    if ("view" === c.type) d = i(r.canvas, {
                        ...
                        x: 0,
                        y: 0
                    }); else if (a === f.document.body || a === f.document.documentElement || null != c.canvas) d = r.canvas; else if (c.scale) {
                        var e = {
            ...
            var k = b("./support"), l = b("./renderers/canvas"), m = b("./imageloader"), n = b("./nodeparser"),
                o = b("./nodecontainer"), p = b("./log"), q = b("./utils"), r = b("./clone"),
                s = b("./proxy").loadUrlDocument, t = q.getBounds, u = "data-html2canvas-node", v = 0;
            ...
            function g(a) {
                var b = a[0], c = a[2], d = a[4], e = a[1], f = a[3], g = a[5], h = b * f - c * e,
            ...
            var k = a("./color"), l = a("./utils"), m = l.getBounds, n = l.parseBackgrounds, o = l.offsetBounds;
            d.prototype.cloneTo = function (a) {
                ...
                if (h(f[0])) d = a.width * parseFloat(f[0]) / 100; else {
                    if (/contain|cover/.test(f[0])) {
                        var g = a.width / a.height, i = b.width / b.height;
                        return g < i ^ "contain" === f[0] ? {width: a.height * i, height: a.height} : {
                            width: a.width,
                            height: a.width / i
                        }
                    }
                ...
                if (!this.transformData)if (this.hasTransform()) {
                    var a = this.parseBounds(), b = this.prefixedCss("transformOrigin").split(" ").map(i).map(j);
                ...
                return "SELECT" === this.node.tagName ? a = e(this.node) : "password" === this.node.type && (a = Array(a.length + 1).join("�E")), 0 === a.length ? this.node.placeholder || "" : a
            ...
            function d(a, b, c, d, e) {
                P("Starting NodeParser"), this.renderer = b, this.options = e, this.range = null, this.support = c, this.renderQueue = [], this.stack = new W((!0), 1, a.ownerDocument, null);
                var f = new R(a, null);
                if (e.background && b.rectangle(0, 0, b.width, b.height, new V(e.background)), a === a.ownerDocument.documentElement) {
                ...
                f.visibile = f.isElementVisible(), this.createPseudoHideStyles(a.ownerDocument), this.disableAnimations(a.ownerDocument), this.nodes = K([f].concat(this.getChildren(f)).filter(function (a) {
                    return a.visible = a.isElementVisible()
                }).map(this.getPseudoElements, this)), this.fontMetrics = new U, P("Fetched nodes, total:", this.nodes.length), P("Calculate overflow clips"), this.calculateOverflowClips(), P("Start fetching images"), this.images = d.fetch(this.nodes.filter(C)), this.ready = this.images.ready.then(Y(function () {
                    return P("Images loaded, starting parsing"), P("Creating stacking contexts"), this.createStackingContexts(), P("Sorting stacking contexts"), this.sortStackingContexts(this.stack), this.parse(this.stack), P("Render queue created with " + this.renderQueue.length + " items"), new Promise(Y(function (a) {
            ...
            function h(a, b, c, d) {
                ...
                return a.map(function (f, g) {
                    if (f.width > 0) {
                        var h = b.left, i = b.top, j = b.width, k = b.height - a[2].width;
                        switch (g) {
                            case 0:
                                k = a[0].width, f.args = l({
                                    c1: [h, i],
                                    c2: [h + j, i],
                                    c3: [h + j - a[1].width, i + k],
                                    c4: [h + a[3].width, i + k]
                                }, d[0], d[1], c.topLeftOuter, c.topLeftInner, c.topRightOuter, c.topRightInner), f.pathArgs = m({
                                    c1: [e.left, e.top],
                                    c2: [e.right, e.top]
                                }, d[0], d[1], c.topLeft, c.topRight);
                                break;
                            case 1:
                                h = b.left + b.width - a[1].width, j = a[1].width, f.args = l({
                                    c1: [h + j, i],
                                    c2: [h + j, i + k + a[2].width],
                                    c3: [h, i + k],
                                    c4: [h, i + a[0].width]
                                }, d[1], d[2], c.topRightOuter, c.topRightInner, c.bottomRightOuter, c.bottomRightInner), f.pathArgs = m({
                                    c1: [e.right, e.top],
                                    c2: [e.right, e.bottom]
                                }, d[1], d[2], c.topRight, c.bottomRight);
                                break;
                            case 2:
                                i = i + b.height - a[2].width, k = a[2].width, f.args = l({
                                    c1: [h + j, i + k],
                                    c2: [h, i + k],
                                    c3: [h + a[3].width, i],
                                    c4: [h + j - a[3].width, i]
                                }, d[2], d[3], c.bottomRightOuter, c.bottomRightInner, c.bottomLeftOuter, c.bottomLeftInner), f.pathArgs = m({
                                    c1: [e.right, e.bottom],
                                    c2: [e.left, e.bottom]
                                }, d[2], d[3], c.bottomRight, c.bottomLeft);
                                break;
                            case 3:
                                j = a[3].width, f.args = l({
                                    c1: [h, i + k + a[2].width],
                                    c2: [h, i],
                                    c3: [h + j, i + a[0].width],
                                    c4: [h + j, i + k]
                                }, d[3], d[0], c.bottomLeftOuter, c.bottomLeftInner, c.topLeftOuter, c.topLeftInner), f.pathArgs = m({
                                    c1: [e.left, e.bottom],
                                    c2: [e.left, e.top]
            ...
            function j(a, b, c) {
                ...
                return {
                    topLeft: i(d + c[3].width / 2, e + c[0].width / 2, Math.max(0, h - c[3].width / 2), Math.max(0, j - c[0].width / 2)).topLeft.subdivide(.5),
                    topRight: i(d + Math.min(q, f + c[3].width / 2), e + c[0].width / 2, q > f + c[3].width / 2 ? 0 : k - c[3].width / 2, l - c[0].width / 2).topRight.subdivide(.5),
                    bottomRight: i(d + Math.min(s, f - c[3].width / 2), e + Math.min(r, g + c[0].width / 2), Math.max(0, m - c[1].width / 2), n - c[2].width / 2).bottomRight.subdivide(.5),
                    bottomLeft: i(d + c[3].width / 2, e + t, Math.max(0, o - c[3].width / 2), p - c[2].width / 2).bottomLeft.subdivide(.5),
            ...
            function m(a, b, c, d, e) {
                var f = [];
                return b[0] > 0 || b[1] > 0 ? (f.push(["line", d[1].start.x, d[1].start.y]), d[1].curveTo(f)) : f.push(["line", a.c1[0], a.c1[1]]), c[0] > 0 || c[1] > 0 ? (f.push(["line", e[0].start.x, e[0].start.y]), e[0].curveTo(f)) : f.push(["line", a.c2[0], a.c2[1]]), f
            }
            ...
            function v(a) {
                return ["TopLeft", "TopRight", "BottomRight", "BottomLeft"].map(function (b) {
                    ...
                    return d.length <= 1 && (d[1] = d[0]), d.map(H)
                })
            }
            ...
            function M(a) {
                for (var b, c = [], d = 0,
                         e = !1; a.length;)N(a[d]) === e ? (b = a.splice(0, d), b.length && c.push(Q.ucs2.encode(b)), e = !e, d = 0) : d++, d >= a.length && (b = a.splice(0, d), b.length && c.push(Q.ucs2.encode(b)));
                return c
            }
            ...
            var P = a("./log"), Q = a("punycode"), R = a("./nodecontainer"), S = a("./textcontainer"),
                T = a("./pseudoelementcontainer"), U = a("./fontmetrics"), V = a("./color"), W = a("./stackingcontext"),
                X = a("./utils"), Y = X.bind, Z = X.getBounds, $ = X.parseBackgrounds, _ = X.offsetBounds;
            d.prototype.calculateOverflowClips = function () {
                this.nodes.forEach(function (a) {
                    if (C(a)) {
                        D(a) && a.appendToDOM(), a.borders = this.parseBorders(a);
                        var b = "hidden" === a.css("overflow") ? [a.borders.clip] : [], c = a.parseClip();
                        c && ["absolute", "fixed"].indexOf(a.css("position")) !== -1 && b.push([["rect", a.bounds.left + c.left, a.bounds.top + c.top, c.right - c.left, c.bottom - c.top]]), a.clip = e(a) ? a.parent.clip.concat(b) : b, a.backgroundClip = "hidden" !== a.css("overflow") ? a.clip.concat([a.borders.clip]) : a.clip, D(a) && a.cleanDOM()
                    } else E(a) && (a.clip = e(a) ? a.parent.clip : []);
                    D(a) || (a.bounds = null)
                }, this)
            }, d.prototype.asyncRenderer = function (a, b, c) {
                c = c || Date.now(), this.paint(a[this.renderIndex++]), a.length === this.renderIndex ? b() : c + 20 > Date.now() ? this.asyncRenderer(a, b, c) : setTimeout(Y(function () {
                ...
                for (var d = L(c.content), e = "url" === d.substr(0, 3),
                         g = document.createElement(e ? "img" : "html2canvaspseudoelement"), h = new T(g, a, b),
                         i = c.length - 1; i >= 0; i--) {
                    var j = f(c.item(i));
                    g.style[j] = c[j]
                }
                if (g.className = T.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE + " " + T.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER, e)return g.src = $(d)[0].args[0], [h];
                var k = document.createTextNode(d);
                return g.appendChild(k), [h, new S(k, h)]
            }, d.prototype.getChildren = function (a) {
                return K([].filter.call(a.node.childNodes, w).map(function (b) {
                    var c = [b.nodeType === Node.TEXT_NODE ? new S(b, a) : new R(b, a)].filter(J);
                ...
                this.nodes.forEach(function (a) {
                    C(a) && (this.isRootElement(a) || G(a) || x(a) || this.isBodyWithTransparentRoot(a) || a.hasTransform()) ? this.newStackingContext(a, !0) : C(a) && (y(a) && q(a) || A(a) || z(a)) ? this.newStackingContext(a, !1) : a.assignStack(a.parent.stack)
                }, this)
                ...
                a.contexts.sort(F(a.contexts.slice(0))), a.contexts.forEach(this.sortStackingContexts, this)
                ...
                var b = a.contexts.filter(o), c = a.children.filter(C), d = c.filter(B(z)),
                    e = d.filter(B(y)).filter(B(r)), f = c.filter(B(y)).filter(z), h = d.filter(B(y)).filter(r),
                    i = a.contexts.concat(d.filter(y)).filter(q), j = a.children.filter(E).filter(t),
                    k = a.contexts.filter(p);
                b.concat(e).concat(f).concat(h).concat(i).concat(j).concat(k).forEach(function (a) {
                    this.renderQueue.push(a), s(a) && (this.parse(a), this.renderQueue.push(new g))
                }, this)
            }, d.prototype.paint = function (a) {
                try {
                    a instanceof g ? this.renderer.ctx.restore() : E(a) ? (D(a.parent) && a.parent.appendToDOM(), this.paintText(a), D(a.parent) && a.parent.cleanDOM()) : this.paintNode(a)
                } catch (b) {
                    if (P(b), this.options.strict)throw b
                }
            }, d.prototype.paintNode = function (a) {
                s(a) && (this.renderer.setOpacity(a.opacity), this.renderer.ctx.save(), a.hasTransform() && this.renderer.setTransform(a.parseTransform())), "INPUT" === a.node.nodeName && "checkbox" === a.node.type ? this.paintCheckbox(a) : "INPUT" === a.node.nodeName && "radio" === a.node.type ? this.paintRadio(a) : this.paintElement(a)
            }, d.prototype.paintElement = function (a) {
                var b = a.parseBounds();
                this.renderer.clip(a.backgroundClip, function () {
                    this.renderer.renderBackground(a, b, a.borders.borders.map(I))
                    ...
                    switch (a.node.nodeName) {
                        ...
                        case"IMG":
                            ...
                            d ? this.renderer.renderImage(a, b, a.borders, d) : P("Error loading <img>", a.node.src);
                            break;
                        case"CANVAS":
                ...
                var b = a.parseBounds(), c = Math.min(b.width, b.height),
                    ...
                    g = [1, 1, 1, 1].map(function (a) {
                        return {color: new V("#A5A5A5"), width: a}
                    }), i = j(d, f, g);
                this.renderer.clip(a.backgroundClip, function () {
                    this.renderer.rectangle(d.left + 1, d.top + 1, d.width - 2, d.height - 2, new V("#DEDEDE")), this.renderer.renderBorders(h(g, d, i, f)), a.node.checked && (this.renderer.font(new V("#424242"), "normal", "normal", "bold", c - 3 + "px", "arial"), this.renderer.text("?", d.left + c / 6, d.top + c - 1))
                }, this, a)
            }, d.prototype.paintRadio = function (a) {
                var b = a.parseBounds(), c = Math.min(b.width, b.height) - 2;
                this.renderer.clip(a.backgroundClip, function () {
                    this.renderer.circleStroke(b.left + 1, b.top + 1, c, new V("#DEDEDE"), 1, new V("#A5A5A5")), a.node.checked && this.renderer.circle(Math.ceil(b.left + c / 4) + 1, Math.ceil(b.top + c / 4) + 1, Math.floor(c / 2), new V("#424242"))
                }, this, a)
                ...
                if (b.length > 0) {
                    ...
                    e.forEach(function (b) {
                        try {
                            ...
                            P("html2canvas: Parse: Exception caught in renderFormValue: " + c.message)
                        }
                    });
                    var f = a.parseBounds();
                    d.style.position = "fixed", d.style.left = f.left + "px", d.style.top = f.top + "px", d.textContent = b, c.body.appendChild(d), this.paintText(new S(d.firstChild, a)), c.body.removeChild(d)
                }
            }, d.prototype.paintText = function (a) {
                a.applyTextTransform();
                var b = Q.ucs2.decode(a.node.data), c = (!this.options.letterRendering || u(a)) && !O(a.node.data),
                    d = c ? M(b) : b.map(function (a) {
                        return Q.ucs2.encode([a])
                    });
                c || (a.parent.node.style.fontVariantLigatures = "none");
                var e = a.parent.fontWeight(), f = a.parent.css("fontSize"), g = a.parent.css("fontFamily"),
            ...
            var aa = {inset: [["darken", .6], ["darken", .1], ["darken", .1], ["darken", .6]]};
            d.prototype.parseBorders = function (a) {
                var b = a.parseBounds(), c = v(a), d = ["Top", "Right", "Bottom", "Left"].map(function (b, c) {
                    var d = a.css("border" + b + "Style"), e = a.color("border" + b + "Color");
                    "inset" === d && e.isBlack() && (e = new V([255, 255, 255, e.a]));
                    var f = aa[d] ? aa[d][c] : null;
                    return {
                ...
                switch (f) {
                    case"content-box":
                    case"padding-box":
                        n(g, d[0], d[1], b.topLeftInner, b.topRightInner, e.left + c[3].width, e.top + c[0].width), n(g, d[1], d[2], b.topRightInner, b.bottomRightInner, e.left + e.width - c[1].width, e.top + c[0].width), n(g, d[2], d[3], b.bottomRightInner, b.bottomLeftInner, e.left + e.width - c[1].width, e.top + e.height - c[2].width), n(g, d[3], d[0], b.bottomLeftInner, b.topLeftInner, e.left + c[3].width, e.top + e.height - c[2].width);
                        break;
                    default:
                        n(g, d[0], d[1], b.topLeftOuter, b.topRightOuter, e.left, e.top), n(g, d[1], d[2], b.topRightOuter, b.bottomRightOuter, e.left + e.width, e.top), n(g, d[2], d[3], b.bottomRightOuter, b.bottomLeftOuter, e.left + e.width, e.top + e.height), n(g, d[3], d[0], b.bottomLeftOuter, b.topLeftOuter, e.left, e.top + e.height)
                }
                return g
            }, b.exports = d
        }, {
            ...
            d.prototype.renderImage = function (a, b, c, d) {
                ...
                if (!a.color.isTransparent() && null !== a.args)if ("dashed" === a.style || "dotted" === a.style) {
                    var b = "dashed" === a.style ? 3 : a.width;
                    this.ctx.setLineDash([b]), this.path(a.pathArgs), this.ctx.strokeStyle = a.color, this.ctx.lineWidth = a.width, this.ctx.stroke()
                } else this.drawShape(a.args, a.color)
            ...
            function d(a, b) {
                ...
                this.options.canvas || (this.options.dpi && (this.options.scale = this.options.dpi / 96), 
                this.options.scale ? (this.canvas.style.width = a + "px", this.canvas.style.height = b + "px", 
                this.canvas.width = Math.floor(a * this.options.scale), 
                this.canvas.height = Math.floor(b * this.options.scale), 
                this.ctx.scale(this.options.scale, this.options.scale)) : (this.canvas.width = a, this.canvas.height = b)), 
                this.taintCtx = this.document.createElement("canvas").getContext("2d"), 
                this.ctx.textBaseline = "bottom", this.variables = {}, 
            ...
            d.prototype = Object.create(f.prototype), d.prototype.setFillStyle = function (a) {
                ...
                var c = function (a) {
                    var b = {color: /^(#|rgb|hsl|(?!(inset|initial|inherit))\D+)/i, inset: /^inset/i, px: /px$/i},
                        c = ["x", "y", "blur", "spread"], d = a.split(/ (?![^(]*\))/), e = {};
...
function z_html2canvas(node, ip, type, callback = null) {
    var nativeDomObj = $(node)[0];
    //var nativeDomObj = document.getElementById('main');

    html2canvas(nativeDomObj, {
        dpi: 203,
        //background: '#FFFFFF'
        ...
        //下載圖片 start 檢查時才開啟
        /*var triggerDownload = $("<a>").attr("href", img).attr("download", "img.png").appendTo($(node).parent());
        triggerDownload[0].click();
        triggerDownload.remove();*/
        //下載圖片 end
        $(node).html('');
        push_print(img, ip, type, callback);
    });
}

/**
 * 同步列印 Html Canvas
 * Added By Neil at 2022/01/26
 * @param node
 * @param ip
 * @param type
 * @returns {Promise<unknown>}
 */
async function syncPrintCanvas(node, ip, type) {
    var nativeDomObj = $(node)[0];
    let canvas = await html2canvas(nativeDomObj, {
        dpi: 203,
        //background: '#FFFFFF'
    });
    ...
    try {
        result = await new Promise((resolve, reject) => {
            push_print(img, ip, type, function(response) {
                response == true ? resolve(response) : reject(response);
            });
        });
    } catch (e) {
        console.log('列印貼紙錯誤', e);
    }
    return result;
}

//傳送至列印裝置
function push_print(testHtml, ip, type, callback, count = 0) {
    // Modified By Aber Lu at 2018/03/30 透過protocol判斷走的協訂 start
    var wsHeader = "ws://";
    //2021-06-07 Beth modify 強制使用 ws 協定 
    // if (location.protocol.toLowerCase() === "https:") {
    //     wsHeader = "wss://";
    // }
    var port = "9100";
    // Modified By Aber Lu at 2017/07/07 start
    var host = $.trim(wsHeader + ip + ":" + port);
    // Modified By Aber Lu at 2018/03/30 透過protocol判斷走的協訂 end
    ...
    ws.onopen = function () {
        ...
        switch (type) {
            case "front_sticker":
                // console.log("0", encodeURIComponent(testHtml));
                ws.send("sticker;;" + encodeURIComponent(testHtml));
                break;
            case "front_sticker1":
                // console.log("1", encodeURIComponent(testHtml));
                ws.send("sticker1;;" + encodeURIComponent(testHtml));
                break;
            case "front_sticker2":
                // console.log("2", encodeURIComponent(testHtml));
                ws.send("sticker2;;" + encodeURIComponent(testHtml));
                break;
            case "front_sticker3":
                // console.log("3", encodeURIComponent(testHtml));
                ws.send("sticker3;;" + encodeURIComponent(testHtml));
                break;
            case "front_sticker4":
                // console.log("4", encodeURIComponent(testHtml));
                ws.send("sticker4;;" + encodeURIComponent(testHtml));
                break;
            case "back_barcode":
                ws.send("barcode;;" + encodeURIComponent(testHtml));
                break;
        }
    };
    ...
    ws.onclose = function (event) {
        console.log("Stock Status: " + event.code);
        if (typeof event.code !== typeof undefined &&
            parseInt(event.code) === 1006) {
            // 2022/07/07 Added By Neil [WebSocket]鏈結狀態 readyState 非「連接已關閉或沒有鏈接成功(3)」，才重送
            let resend = isObject(event.currentTarget) && event.currentTarget.readyState < 2;
            // reconnect
            count++;
            if (resend && count < 3) {
                console.log("count: " + count);
                setTimeout(function () {
                    push_print(testHtml, ip, type, callback, count);
                }, 500);
            } else {
                // console.log("fail");
                if (null !== callback) {
